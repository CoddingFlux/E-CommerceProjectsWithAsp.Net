                     ...
                     <div class="tp-login-wrapper">
                        ...
                        <div class="tp-login-option">
                           ...
                           <div class="tp-login-input-wrapper">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                     <asp:TextBox ID="txtname" runat="server" placeholder="Enter full name" required="required"></asp:TextBox>
                                 </div>
                                 <div class="tp-login-input-title">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                     <asp:TextBox type="email" ID="txtemail" runat="server" placeholder="Enter email" required="required"></asp:TextBox>
                                 </div>
                                 <div class="tp-login-input-title">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                     <asp:TextBox ID="txtpassword" type="password" runat="server" placeholder="Min. 6 character" required="required"></asp:TextBox>
                                 </div>
                           ...
                           <div class="tp-login-bottom">
                               <asp:Button ID="Button1"  class="tp-login-btn w-100" runat="server" Text="SignUp" OnClick="Button1_Click" />
                           </div>
                        </div>
                     </div>
                  </div>
