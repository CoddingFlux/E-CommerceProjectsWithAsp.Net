<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Shopping.Profile1" %>
                                    ...
                                    <div class="row align-items-center">
                                       <div class="col-md-6">
                                          <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                             ...
                                             <div class="profile__main-content">
                                                <h4 class="profile__main-title">Welcome,<%= Session["username"] %></h4>
                                       ...
                                       <div class="col-md-6">
                                          <div class="profile__main-logout text-sm-end">
                                             <a href="Logout.aspx" class="tp-logout-btn">Logout</a>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
