<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="header.ascx.cs" Inherits="Shopping.Admin.Include.header" %>
<!doctype html>
                                ...
                                <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                                    <div class="tp-header-top-menu-item tp-header-lang">
                                        <%if (Session != null && Session["adminid"] != null)
                                            { %>
                                         <span class="tp-header-lang-toggle" id="tp-header-lang-toggle">Welcome,<%= Session["adminname"] %></span>
                                        <%}
                                            else
                                            {%>
