<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shop_Category.aspx.cs" Inherits="Shopping.Shop_Category1" %>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        <div class="tp-category-main-thumb include-bg transition-3">
                            <asp:Image ID="Image1" ImageUrl='<%# Eval("Category_Image") %>' runat="server"/></div>
