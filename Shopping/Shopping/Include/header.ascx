<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="header.ascx.cs" Inherits="Shopping.Include.header" %>
<!doctype html>
<html class="no-js" lang="zxx">

<!-- Mirrored from html.hixstudio.net/shofy-prv/shofy/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Mar 2024 15:29:52 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="cartmini__wrapper d-flex justify-content-between flex-column">
            ...
            <div class="cartmini__checkout">
                ...
                <div class="cartmini__checkout-btn">
                    <a href="Cart.aspx" class="tp-btn mb-10 w-100">view cart</a>
                    <a href="Checkout.aspx" class="tp-btn tp-btn-border w-100">checkout</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                                    <div class="tp-header-top-menu-item tp-header-lang">
                                        <%if (Session != null && Session["userid"] != null)
                                            { %>
                                         <span class="tp-header-lang-toggle" id="tp-header-lang-toggle">Welcome,<%= Session["username"] %></span>
                                        <%}
                                            else
                                            {%>
                                        <span class="tp-header-lang-toggle" id="tp-header-lang-toggle">My Account</span>
                                        <%} %>
                                        <ul>
                                            <% 
                                                if (Session != null && Session["userid"] != null)
                                ...
                                <div class="main-menu menu-style-2">
                                    <nav class="tp-main-menu-content">
                                        <ul>
                                            ...
                                            <li class="">
                                                <a href="Shop_Category.aspx">Category</a>
                                            </li>
                                                ...
                                                <ul class="mega-menu tp-submenu">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html">
                                                                    <img src="assets/img/header/menu/menu-1.jpg" alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html">
                                                                    <img src="assets/img/header/menu/menu-2.jpg" alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html">
                                                                    <img src="assets/img/header/menu/menu-3.jpg" alt=""></a>
                                                            </li>
                                                            <li>
                                ...
                                <div class="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30">
                                    ...
                                    <div class="tp-header-action d-flex align-items-center ml-30">
                                        ...
                                        <div class="tp-header-action-item d-none d-lg-block">
                                            <a href="Wishlist.aspx" class="tp-header-action-btn">
                                        ...
                                        <div class="tp-header-action-item">
                                            <a class="tp-header-action-btn cartmini-open-btn">
